...
void dod_init(void)
{
    ...
    if( ( (g_rtc_fg_soc != 0) && (( ( (abs(g_rtc_fg_soc-gFG_capacity_by_v) ) <= CUST_POWERON_DELTA_CAPACITY_TOLRANCE) ) || (abs(gFG_capacity_by_v_init - g_rtc_fg_soc) < abs(gFG_capacity_by_v - gFG_capacity_by_v_init))))
