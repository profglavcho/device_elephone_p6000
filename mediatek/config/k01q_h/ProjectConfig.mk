...
CUSTOM_LK_LCM=otm9605a_qhd_dsi_vdo ili9881_hd720_dsi_vdo
...
CUSTOM_KERNEL_LCM=otm9605a_qhd_dsi_vdo ili9881_hd720_dsi_vdo

# To choose uboot LCM driver name
CUSTOM_UBOOT_LCM=otm9605a_qhd_dsi_vdo ili9881_hd720_dsi_vdo
...
#CREATE_PROJECT_INFO=2014102010329
MTK_BUILD_VERNO = ALPS.KK2.MP13.V1.27
# To enable custom partition
MTK_CIP_SUPPORT=yes

#add by liliang.bao 
NB_PRODUCT_LOCALES=en_US es_ES zh_CN zh_TW ru_RU pt_BR fr_FR de_DE tr_TR it_IT in_ID ms_MY vi_VN ar_EG  th_TH  pt_PT   nl_NL el_GR hu_HU tl_PH ro_RO cs_CZ iw_IL my_MM km_KH ko_KR pl_PL es_US bg_BG hr_HR lv_LV lt_LT sk_SK uk_UA de_AT da_DK fi_FI nb_NO sv_SE en_GB et_EE
NB_LOCALES_CHINESE_SUPPORT=no
NB_UPDATE_APP=no
#adupsfota start
...
#adupsfota end
#replace original camera with nexus camera
NB_CAM_ORIGINAL_CAM_DISABLE=no
NB_USER_ROOT=yes
NB_USER_DEBUG=yes
NB_INSERT_PRESET_CONTACT=no
#add by lzp for disable sw uvlo
MTK_SET_PMIC_SW_UVLO_DISABLE=yes
