...
#endif
#if defined(VM149CAF)
extern PFUNC_GETLENSDEFAULT pVM149CAF_getDefaultData;
#endif
...
MSDK_LENS_INIT_FUNCTION_STRUCT LensList_main[MAX_NUM_OF_SUPPORT_LENS] =
{
    {DUMMY_SENSOR_ID, DUMMY_LENS_ID, "Dummy", pDummy_getDefaultData},
        ...
        {IMX219_SENSOR_ID, FM50AF_LENS_ID, "FM50AF", pFM50AF_getDefaultData},
    #endif
    #if defined(DW9714AF)
	...
	{OV8858R1A_SENSOR_ID, DW9714AF_LENS_ID, "DW9714AF", pDW9714AF_getDefaultData},	
//	{OV13850_SENSOR_ID, VM149CAF_LENS_ID, "VM149CAF", pVM149CAF_getDefaultData},
    #endif
    #if defined(AD5820AF)
