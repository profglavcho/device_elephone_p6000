...
LID_BIT VER_LID(AP_CFG_CUSTOM_FILE_FACTORY_HEADER_LID)
Factory_header_Struct *CFG_FILE_FACTORY_HEADER_REC_TOTAL
{

};

LID_BIT VER_LID(AP_CFG_CUSTOM_FILE_FACTORY_TEST_RESULT_LID)
Factory_test_result_Struct *CFG_FILE_FACTORY_RESULT_REC_TOTAL
{
