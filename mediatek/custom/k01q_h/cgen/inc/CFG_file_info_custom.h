...
#include "CFG_Custom1_F_Default.h"
#include "CFG_Custom1_F_File.h"
...
extern "C"
{
	...
	{
            "/data/nvram/APCFG/APRDEB/Factory_header",         VER(AP_CFG_CUSTOM_FILE_FACTORY_HEADER_LID),	          CFG_FILE_FACTORY_HEADER_REC_SIZE,
            CFG_FILE_FACTORY_HEADER_REC_TOTAL,                  DEFAULT_ZERO,                0, DataReset , NULL
        },

	{
            "/data/nvram/APCFG/APRDEB/Factory_test_result",         VER(AP_CFG_CUSTOM_FILE_FACTORY_TEST_RESULT_LID),	           CFG_FILE_FACTORY_RESULT_REC_SIZE,
            CFG_FILE_FACTORY_RESULT_REC_TOTAL,                  DEFAULT_ZERO,                0, DataReset , NULL
        },
    };
    ...
    int iFileFactoryHeaderLID=AP_CFG_CUSTOM_FILE_FACTORY_HEADER_LID;
    extern int iFileFactoryHeaderLID;
    int iFileFactoryTestResultLID=AP_CFG_CUSTOM_FILE_FACTORY_TEST_RESULT_LID;
    extern int iFileFactoryTestResultLID;
#ifdef __cplusplus
}
#endif
