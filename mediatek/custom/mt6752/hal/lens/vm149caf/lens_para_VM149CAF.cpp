...
const NVRAM_LENS_PARA_STRUCT VM149CAF_LENS_PARA_DEFAULT_VALUE =
{
    //Version
...
UINT32 VM149CAF_getDefaultData(VOID *pDataBuf, UINT32 size)
{
    ...
    memcpy(pDataBuf, &VM149CAF_LENS_PARA_DEFAULT_VALUE, dataSize);

    return 0;
}

PFUNC_GETLENSDEFAULT pVM149CAF_getDefaultData = VM149CAF_getDefaultData;
