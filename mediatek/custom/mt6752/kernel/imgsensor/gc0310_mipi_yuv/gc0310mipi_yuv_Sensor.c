...
static void GC0310_Set_Mirrorflip(kal_uint8 image_mirror)
{
	...
	switch (image_mirror)
	{
		case IMAGE_NORMAL://IMAGE_NORMAL:
			GC0310_write_cmos_sensor(0x17,0x17);//bit[1][0]
...
//		break;
    ...
    case SENSOR_FEATURE_GET_DELAY_INFO:
        ...
        GC0310_MIPI_GetDelayInfo(*pFeatureData32);
    break;

    case SENSOR_FEATURE_GET_DEFAULT_FRAME_RATE_BY_SCENARIO:
         SENSORDB("[GC0310] F_GET_DEFAULT_FRAME_RATE_BY_SCENARIO\n");
         GC0310_MIPI_GetDefaultFramerateByScenario((MSDK_SCENARIO_ID_ENUM)*pFeatureData32, (MUINT32 *)(*(pFeatureData32+1)));
    break;   
	...
	case SENSOR_FEATURE_GET_EXIF_INFO:
		 ...
		 GC0310_MIPI_GetExifInfo(*pFeatureData32);
		 break;
