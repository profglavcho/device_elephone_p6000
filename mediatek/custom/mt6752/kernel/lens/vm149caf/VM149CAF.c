...
#define AF_DRVNAME "VM149CAF"
#define I2C_SLAVE_ADDRESS        0x18
#define I2C_REGISTER_ID            0x19
#define PLATFORM_DRIVER_NAME "lens_actuator_vm149caf"
#define AF_DRIVER_CLASS_NAME "actuatordrv_vm149caf"
...
inline static int getAFInfo(__user stVM149CAF_MotorInfo * pstMotorInfo)
{
    stVM149CAF_MotorInfo stMotorInfo;
    ...
    if(copy_to_user(pstMotorInfo , &stMotorInfo , sizeof(stVM149CAF_MotorInfo)))
    {
...
#ifdef LensdrvCM3
inline static int getAFMETA(__user stVM149CAF_MotorMETAInfo * pstMotorMETAInfo)
{
    stVM149CAF_MotorMETAInfo stMotorMETAInfo;
    ...
    if(copy_to_user(pstMotorMETAInfo , &stMotorMETAInfo , sizeof(stVM149CAF_MotorMETAInfo)))
    {
        LOG_INF("copy to user failed when getting motor information \n");
    }
...
unsigned long a_u4Param)
{
    ...
    switch(a_u4Command)
    {
        case VM149CAFIOC_G_MOTORINFO :
            i4RetValue = getAFInfo((__user stVM149CAF_MotorInfo *)(a_u4Param));
        break;
        #ifdef LensdrvCM3
        case VM149CAFIOC_G_MOTORMETAINFO :
            i4RetValue = getAFMETA((__user stVM149CAF_MotorMETAInfo *)(a_u4Param));
        break;
        #endif
        case VM149CAFIOC_T_MOVETO :
            i4RetValue = moveAF(a_u4Param);
        break;

        case VM149CAFIOC_T_SETINFPOS :
            i4RetValue = setAFInf(a_u4Param);
        break;

        case VM149CAFIOC_T_SETMACROPOS :
...
static int __init VM149CAF_i2C_init(void)
{
...
static void __exit VM149CAF_i2C_exit(void)
{
    platform_driver_unregister(&g_stAF_Driver);
}

module_init(VM149CAF_i2C_init);
module_exit(VM149CAF_i2C_exit);

MODULE_DESCRIPTION("VM149CAF lens module driver");
