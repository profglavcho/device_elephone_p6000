...
)
{
    ...
    if(EnableSWResizerFlag)
    {
        ...
        MY_LOGD("FDVTMain IN");
        m_pMTKFDVTObj->FDVTMain( (MUINT32)ImageScaleBuffer, (MUINT32)ImageBuffer1, FDVT_GFD_MODE, direction, 0, (MUINT32)ImageBufferPhy);
        ...
        */
        ...
        if(SDEnable)
        {
            ...
            m_pMTKFDVTObj->FDVTMain( (MUINT32)ImageScaleBuffer, (MUINT32)y_vga, FDVT_SD_MODE, direction, 0, (MUINT32)ImageBufferPhy);
			MY_LOGD("FDVT_SD_MODE out");
        }
    }
    else
    {
    		m_pMTKFDVTObj->FDVTMain( (MUINT32)ScaleImages, (MUINT32)ImageBuffer1, FDVT_GFD_MODE, direction, 0, (MUINT32)ImageBufferPhy);
    		
    		if(SDEnable)
    		{
    		    m_pMTKFDVTObj->FDVTMain( (MUINT32)ScaleImages, (MUINT32)ImageBuffer2, FDVT_SD_MODE, direction, 0, (MUINT32)ImageBufferPhy);
    	  }
    }
