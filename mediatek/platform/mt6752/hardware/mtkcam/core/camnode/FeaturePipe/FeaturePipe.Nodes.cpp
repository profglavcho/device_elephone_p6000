...
FeaturePipeNode::createInstance(FeaturePipeNodeObject_e eobject, MUINT32 featureOnMask, MUINT32 mOpenedSensorIndex, FeaturePipe *pFeaturePipeObj)
{
    if (eobject == FEATURE_STREAM_NODE_CONTROL) {
         ...
         return  FeaturePipeFdNode::createInstance(featureOnMask, pFeaturePipeObj);
    }
#endif
...
#define MIN(a,b) (((a) < (b))? (a): (b))
    ...
    MUINT32 numReadyJobs = MIN(mqFullImgJob.size(),mqDsImgJob.size());
    ...
    MUINT32 newReadyJobs = MIN(mqFullImgJob.size(),mqDsImgJob.size());
