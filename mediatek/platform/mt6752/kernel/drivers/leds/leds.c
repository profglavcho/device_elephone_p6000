...
static uint isink_ch3_step = ISINK_3;
module_param_named(isink_ch3_step, isink_ch3_step, uint, S_IRUGO | S_IWUSR);
static uint isink_breath3_tr1 = 4;
module_param_named(isink_breath3_tr1, isink_breath3_tr1, uint, S_IRUGO | S_IWUSR);
static uint isink_breath3_tr2 = 4;
module_param_named(isink_breath3_tr2, isink_breath3_tr2, uint, S_IRUGO | S_IWUSR);
static uint isink_breath3_tf1 = 4;
module_param_named(isink_breath3_tf1, isink_breath3_tf1, uint, S_IRUGO | S_IWUSR);
static uint isink_breath3_tf2 = 4;
module_param_named(isink_breath3_tf2, isink_breath3_tf2, uint, S_IRUGO | S_IWUSR);
static uint isink_breath3_ton = 2;
module_param_named(isink_breath3_ton, isink_breath3_ton, uint, S_IRUGO | S_IWUSR);
static uint isink_breath3_toff = 3;
module_param_named(isink_breath3_toff, isink_breath3_toff, uint, S_IRUGO | S_IWUSR);
static uint isink_dim3_duty = 15;
module_param_named(isink_dim3_duty, isink_dim3_duty, uint, S_IRUGO | S_IWUSR);
static uint isink_dim3_fsel = 11;
module_param_named(isink_dim3_fsel, isink_dim3_fsel, uint, S_IRUGO | S_IWUSR);
static bool isink_breath3_ctrl_en = false;
module_param_named(isink_breath3_ctrl_en, isink_breath3_ctrl_en, bool, S_IRUGO | S_IWUSR);
	...
	if (pmic_type == MT65XX_LED_PMIC_LCD_ISINK)
	{
		...
		else if(pmic_type == MT65XX_LED_PMIC_NLED_ISINK0)
		{
			...
			if (level == 128)
			{
				mt6325_upmu_set_isink_ch0_mode(PMIC_PWM_1);
				mt6325_upmu_set_isink_ch0_step(ISINK_3);
				mt6325_upmu_set_isink_breath0_tr1_sel(0x01);
				mt6325_upmu_set_isink_breath0_tr2_sel(0x01);
				mt6325_upmu_set_isink_breath0_tf1_sel(0x01);
				mt6325_upmu_set_isink_breath0_tf2_sel(0x01);
				mt6325_upmu_set_isink_breath0_ton_sel(0x01);
				mt6325_upmu_set_isink_breath0_toff_sel(0x01);
				mt6325_upmu_set_isink_dim0_duty(15);
				mt6325_upmu_set_isink_dim0_fsel(11);
			}
			else
		...
		else if(pmic_type == MT65XX_LED_PMIC_NLED_ISINK1)
		{
			...
			if (level == 128)
			{
				mt6325_upmu_set_isink_ch1_mode(PMIC_PWM_1);
				mt6325_upmu_set_isink_ch1_step(ISINK_3);
				mt6325_upmu_set_isink_breath1_tr1_sel(0x01);
				mt6325_upmu_set_isink_breath1_tr2_sel(0x01);
				mt6325_upmu_set_isink_breath1_tf1_sel(0x01);
				mt6325_upmu_set_isink_breath1_tf2_sel(0x01);
				mt6325_upmu_set_isink_breath1_ton_sel(0x01);
				mt6325_upmu_set_isink_breath1_toff_sel(0x01);
				mt6325_upmu_set_isink_dim1_duty(15);
				mt6325_upmu_set_isink_dim1_fsel(11);
			}
			else
		...
		else if(pmic_type == MT65XX_LED_PMIC_NLED_ISINK2)
		{
			...
			if (level == 128)
			{
				mt6325_upmu_set_isink_ch2_mode(PMIC_PWM_1);
				mt6325_upmu_set_isink_ch2_step(ISINK_3);
				mt6325_upmu_set_isink_breath2_tr1_sel(0x01);
				mt6325_upmu_set_isink_breath2_tr2_sel(0x01);
				mt6325_upmu_set_isink_breath2_tf1_sel(0x01);
				mt6325_upmu_set_isink_breath2_tf2_sel(0x01);
				mt6325_upmu_set_isink_breath2_ton_sel(0x01);
				mt6325_upmu_set_isink_breath2_toff_sel(0x01);
				mt6325_upmu_set_isink_dim2_duty(15);
				mt6325_upmu_set_isink_dim2_fsel(11);
			}
			else
		...
		else if(pmic_type == MT65XX_LED_PMIC_NLED_ISINK3)
		{
			...
			{
				mt6325_upmu_set_isink_ch3_mode(PMIC_PWM_1);
				if (isink_breath3_ctrl_en == false)
				{
					mt6325_upmu_set_isink_ch3_step(ISINK_4);//20mA
					mt6325_upmu_set_isink_breath3_tr1_sel(0x04);
					mt6325_upmu_set_isink_breath3_tr2_sel(0x08);
					mt6325_upmu_set_isink_breath3_tf1_sel(0x02);
					mt6325_upmu_set_isink_breath3_tf2_sel(0x08);
					mt6325_upmu_set_isink_breath3_ton_sel(0x01);
					mt6325_upmu_set_isink_breath3_toff_sel(0x01);
					mt6325_upmu_set_isink_dim3_duty(28);//90%
					mt6325_upmu_set_isink_dim3_fsel(11);
				}
				else
				{
					mt6325_upmu_set_isink_ch3_step(isink_ch3_step);
					mt6325_upmu_set_isink_breath3_tr1_sel(isink_breath3_tr1);
					mt6325_upmu_set_isink_breath3_tr2_sel(isink_breath3_tr2);
					mt6325_upmu_set_isink_breath3_tf1_sel(isink_breath3_tf1);
					mt6325_upmu_set_isink_breath3_tf2_sel(isink_breath3_tf2);
					mt6325_upmu_set_isink_breath3_ton_sel(isink_breath3_ton);
					mt6325_upmu_set_isink_breath3_toff_sel(isink_breath3_toff);
					mt6325_upmu_set_isink_dim3_duty(isink_dim3_duty);
					mt6325_upmu_set_isink_dim3_fsel(isink_dim3_fsel);
				}
			}
			else
			{
				...
				mt6325_upmu_set_isink_ch3_step(ISINK_4);//20mA
				if (level == 64) {
					mt6325_upmu_set_isink_dim3_duty(11);// (11/31)=35%
				}
				else if (level == 32) {
					mt6325_upmu_set_isink_dim3_duty(5);// (5/31)=16%
				}
				else {
					mt6325_upmu_set_isink_dim3_duty(28);// (28/31)=90%
				}
