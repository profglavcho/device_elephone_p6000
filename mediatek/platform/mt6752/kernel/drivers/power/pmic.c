...
#ifndef MTK_SET_PMIC_SW_UVLO_DISABLE
    mt6325_upmu_set_rg_uvlo_vthl(0);
    xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[PMIC_UVLO_SETTING] Done\n");
    mt6325_upmu_set_rg_uvlo_vh_lat(1);
#endif
